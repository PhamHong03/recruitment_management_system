            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="branch_name" class="form-control" placeholder="Nhập tên chi nhánh">
                    </div>
                </div>     
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control mb-2" id="city" name="branch_position">
                                <option value="" selected>-- Chọn tỉnh thành --</option>
                            </select>
                            <input name="city_input" class="d-none address_tinh">

                            <select class="form-control mb-2" id="district" name="branch_position">
                                <option value="" selected>-- Chọn quận huyện --</option>
                            </select>
                            <input name="district_input" class="d-none address_huyen">

                            <select class="form-control" id="ward" name="branch_position">
                                <option value="" selected>-- Chọn phường xã --</option>
                            </select>
                            <input name="ward_input" class="d-none address_xa">
                        </div>
                    </div>
                </div>
