            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="branch_name">Tên vị trí</label>
                        <input type="text" name="open_position_name"  class="form-control" placeholder="Nhập tên vị trí tuyển dụng">
                    </div>
                </div>     
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="branch_name">Yêu cầu tuyển dụng</label>
                        <input type="text" name="open_position_requirements"  class="form-control" placeholder="Nhập yêu cầu cho vị trí tuyển dụng">
                    </div>
                </div>     
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="hiring_round_id" class="form-control" id="hiring_round_id" required>
                            ...
                            @foreach ($hiringRounds as $hiringRound)
                                <option value="{{ $hiringRound->id }}">{{ $hiringRound->hiring_round_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="open_position_description" id="description"  class="form-control"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">   
